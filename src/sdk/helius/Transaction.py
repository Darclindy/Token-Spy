...
def transaction_test():
    ...
    with open(f"output/json/transaction/{transactions[0]}", "w") as fp:
        fp.write(json.dumps(raw_transactions))
...
def transaction_history_test():
    ...
    with open(f"output/json/history/{address}", "w") as fp:
        fp.write(json.dumps(parsed_transaction_history))
